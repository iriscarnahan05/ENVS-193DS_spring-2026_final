...
Tree height is a continuous variable measured in meters. The research shows in the second paragraph of the results section that the taller the tree, the more likely  it is that a bird will have nested in in it.
